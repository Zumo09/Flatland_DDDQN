...
class AgentsController:
    ...
    def step(self, state, all_rewards, done):
        ...
        if self.need_to_save:
            ...
            self.memory.add(state, self.agent_obs_buffer, self.agent_action_buffer, all_rewards, self.agent_obs, done)
    ...
    def _train(self, experiences, gamma):
        ...
        a = (gamma * Q_targets_next * (1 - dones))
        Q_targets = rewards + a

        self.agent.fit((obs, states), Q_targets, verbose=0)
