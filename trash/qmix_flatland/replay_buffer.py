...
class ReplayBuffer:
    ...
    def __init__(self, buffer_size, batch_size):
        ...
        self.experience = namedtuple("Experience",
                                     field_names=["state", "observations", "actions", "rewards", "next_obs", "done"])

    def add(self, state, obs, actions, rewards, next_obs, done):
        """Add a new experience to memory."""
        e = self.experience(state, obs, actions, rewards, next_obs, done)
