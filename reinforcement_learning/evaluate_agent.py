...
def evaluate_agents(file, n_evaluation_episodes, render, allow_skipping, allow_caching):
    nb_threads = 1
...
if __name__ == "__main__":
    ...
    evaluate_agents(file=args.file, n_evaluation_episodes=args.n_evaluation_episodes, render=args.render,
