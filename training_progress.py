...
from components.env_config import check_env_config, ENV_CONFIG, OBS_PARAMS
...
def evaluate_agents(file, evaluation_env_config, n_evaluation_episodes, render, allow_skipping, allow_caching):
    ...
    check_env_config(evaluation_env_config)

    params = ENV_CONFIG[evaluation_env_config]
    params.update(OBS_PARAMS[evaluation_env_config])
